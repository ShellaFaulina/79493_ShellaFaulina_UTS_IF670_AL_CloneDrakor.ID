...
const Bookmark = () => {
  ...
  const handleRestore = () => {
    if (!hasBackup) {
      Alert.alert('Peringatan', 'Tidak ada file backup Bookmark!');
      return;
    }
  ...
  const handleSaveBackup = () => {
    ...
    setHasBackup(true);
    Alert.alert('Sukses', `Backup Bookmark disimpan sebagai: ${backupFileName}`);
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.emptyHistory}>
        <Text style={styles.emptyText}>Belum ada Bookmark tersimpan...</Text>
      </View>
      ...
      <Modal transparent={true} visible={restoreModalVisible} animationType="fade">
        <View style={styles.modalOverlay}>
          <View style={styles.modalContainer}>
            <Text style={styles.modalTitle}>Restore Data Bookmark:</Text>
